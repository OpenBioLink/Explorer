...
let rdfMethods = {
    getAllTestEntities(endpoint, namespace){
    ...
    addLabelsToPredictions(endpoint, namespace, predictions){
        return new Promise((resolve, reject) => {
            var query = `query=
    ...
    addLabelsToExplanations(endpoint, namespace, groups, variables, entities, relations){
        return new Promise((resolve, reject) => {
            var query = `query=
                SELECT ?subject ?object
                WHERE {
    ...
    getInfoByCurie(endpoint, namespace, curie){
        return new Promise((resolve, reject) => {
            var query = `query=
    ...
    getRelationlabel(endpoint, namespace, relation){
        return new Promise((resolve, reject) => {
            var query = `query=
                SELECT ?label
                WHERE {
    ...
    addRelationlabelsToTasks(endpoint, namespace, tasks){
        return new Promise((resolve, reject) => {
            var query = `query=
    ...
    getOutgoingEdges(endpoint, namespace, curie){
        return new Promise((resolve, reject) => {
    ...
    getIncomingEdges(endpoint, namespace, curie){
        return new Promise((resolve, reject) => {
            var res = new Proxy({}, {get(target, name){
                if(name === "toJSON" || name === "then"){
                    return undefined;
    ...
    getInstantiations(endpoint, namespace, head, tail, rule){
        return new Promise((resolve, reject) => {
